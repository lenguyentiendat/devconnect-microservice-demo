...
Event được publish sau khi post đã được lưu trong memory của `feed-service`.
...
```json
{
  ...
  "occurredAt": "2026-07-14T10:15:30.1245678"
}
```
...
Sau khi chạy `docker compose up -d`, mở <http://localhost:8085>:
